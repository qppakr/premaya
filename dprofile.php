        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">ข้อมูลส่วนตัว</h3> </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#settings" role="tab">แก้ไขข้อมูลส่วนตัว</a> </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="settings" role="tabpanel">
                                    <div class="card-body">
                                      <form name="EditMember" method="post" action="DPROFILE-UPDATED.php" onSubmit="JavaScript:return fncSubmit();">
                                ...
                                <div class="tab-pane" id="passtab" role="tabpanel">
                                  <form name="EditPassword" method="post" action="DPASSWORD-UPDATED.php" onSubmit="JavaScript:return fncSubmitPass();">
                                    <!-- onSubmit="JavaScript:return fncSubmit();" -->
                                    <iframe id="iframe_target" name="iframe_target" src="#" style="width:0;height:0;border:0px solid #fff;"></iframe>
                                    <div class="card-body">
